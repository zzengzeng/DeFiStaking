...
TOKEN_A="${TOKEN_A:-0xbd1ea15E7F4774Df55b99d4Bae731dD0B4E602DE}"
TOKEN_B="${TOKEN_B:-0x65E926f4B96D9f29082fc6b3758132EcCC73bbf1}"
OPERATOR="${OPERATOR:-}"
...
NEXT_PUBLIC_RPC_URL_SEPOLIA=${SEPOLIA_RPC_URL:-https://ethereum-sepolia-rpc.publicnode.com}
